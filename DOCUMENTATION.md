...
```json
{
  ...
  "data": {                 // Objeto com os dados do template
...
```json
{
  ...
  "listaAssinantes": [              // (Obrigatório) Array de objetos para assinaturas
...
```json
{
  ...
  "itens": [
    { "descricao": "Item 1", "quantidade": 1, "valorUnitario": "10,00", "subtotal": "10,00" }
  ],
  "totais": {
    "subtotal": "10,00",
